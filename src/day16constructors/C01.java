...
public class C01 {
	...
	/*
	 ...
	 4)Note: static olmayan variable veya methodlar static methodlar icinde kullanilamazlar. 
	 Ama static olmayan variable ve methodlari obje uzerinden kullanmak isterseniz
	  Java buna musaade eder.
